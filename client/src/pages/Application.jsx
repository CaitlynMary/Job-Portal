...
const Applications = () => {
    ...
    const[isEdit,setIsEdit] = useState(false)   // Enable edit the resume 
    const[resume,setResume] = useState(null)    // Selected Resume saved in this state
    return (
       <>
         <Navbar/>
            ...
            <table className='min-w-full bg-white border rounded-lg'>
                ...
                <tbody>
                    {userApplications.map((job,index)=> true ? (
                        <tr key={index}>
                           <td className='py-3 px-4 flex items-center gap-2 border-b'><img  className='w-8 h-8' src={job.companyId.image} alt="" /> {job.companyId.name}</td>
