...
const Hero = () => {
  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      <div className='bg-gradient-to-r from-violet-800 to-fuchsia-900 text-white py-16 text-center mx-2 rounded-xl'>
        ...
        <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl  mx-4 sm:mx-auto'>
            ...
            <button onClick={onSearch} className='bg-gradient-to-r from-cyan-500 to-blue-500 px-6 py-2 rounded text-white m-1'>Search</button>
        </div>
      </div>
